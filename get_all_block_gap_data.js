...
async function main() {
  ...
  for (const signal of signals || []) {
    ...
    console.log(`  blockGapMean: ${stats.blockGapMean}, blockGapP75: ${stats.blockGapP75}\n`);
  ...
  fs.writeFileSync('block_gap_stats_complete.csv', csvContent);

  console.log('=== 完成 ===');
  console.log(`CSV文件: block_gap_stats_complete.csv`);
  ...
  console.log(`\n拉砸代币: ${pumpResults.length} 个`);
  console.log(`正常代币: ${normalResults.length} 个`);
}
