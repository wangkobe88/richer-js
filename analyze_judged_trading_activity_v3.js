...
const DELAY_MS = 500; // 每次请求间隔500ms
...
async function getJudgedTokens() {
...
async function main() {
  ...
  console.log(`延迟: ${DELAY_MS}ms, 重试: ${MAX_RETRIES}次\n`);

  const judgedTokens = await getJudgedTokens();
