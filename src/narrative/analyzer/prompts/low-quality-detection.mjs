...
**3.5 平台比赛/竞赛**：B站、抖音、YouTube等平台举办的比赛/竞赛不适合构建meme币
   ...
   - **⚠️ 核心原则：判断语料的核心事件是什么，而不是代币名是否匹配**
     - 如果语料核心是"XX大赛一等奖《作品名》"，核心事件是比赛本身
     - 代币名匹配作品名≠豁免，仍需判断比赛性质
   - **判断标准（满足2项即触发）**：
     1. 平台官方举办（B站、抖音、YouTube、微博等平台官方）
     2. 性质比赛/竞赛（AI创作、编程、设计、视频等技术或创作竞赛）
     3. 风格专业/评选（获奖名单、作品展示、评委点评、颁奖典礼等）
     4. 无社交爆火（仅在专业圈/参赛者中传播，非大众话题）
   - **判断关键词**：大赛、竞赛、比赛、一等奖、获奖、冠军、入围、官方主办、征稿
   - **示例（触发）**：
     - 代币名"牌子"，内容"B站AI创作大赛一等奖《牌子》" → 触发（平台比赛，代币名是作品名）
     - 代币名"AI创作大赛"，内容B站AI创作大赛 → 触发（代币名是比赛名）
     - 代币名"编程冠军"，内容官方编程比赛获奖名单 → 触发（平台比赛）
     - 代币名"金奖作品"，内容某设计大赛金奖作品展示 → 触发（平台比赛）
     - 代币名"流浪地球"，内容"《流浪地球》导演现身AI大赛颁奖" → 触发（平台比赛活动）
   - **示例（不触发）**：
     - ✅ 豆瓣评分9.0的B站视频火了，网友疯狂玩梗 → 不触发（社交爆火，非平台主导）
     - ✅ 某搞笑视频获得"网友最喜爱奖"（非平台官方评选） → 不触发（娱乐性质）
     - ✅ UP主自发举办的"粉丝创作活动"（非平台官方） → 不触发（社区自发）
   - **豁免条件**：
     - 活动是社区自发/非平台官方性质（如UP主发起、网友投票、娱乐评选）
     - 内容有娱乐化处理/社交爆火/meme元素
...
**第三阶段触发：有相关性但质量低**
{"pass": false, "stage": 3, "scenario": 1-5, "reason": "说明理由", "entities": {...}}
...
- 当stage=3时，scenario字段必须是1-5的数字，对应五个场景`);
