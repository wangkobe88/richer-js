...
3. 推文有Website链接，指向品牌官网、新闻文章等外部内容
4. 推文作者粉丝很少（<1000），但内容讨论的是大品牌/大事件
...
- **顶级科技品牌事件**（百度、阿里、腾讯、字节、Apple、Google、Microsoft、Tesla等）→ 18-25分
  - 示例：百度AI产品发布、Apple新品发布会、Tesla新功能 → 18-25分
...
- **中等质量**（10-19分）：3-5字、有一定意义但不突出
  - 示例："硅基茶水间"（5字）、"来根麻子"（4字）、"佛系青年"
- **低质量**（0-9分）：6+字、过长、难记
  - 示例："绿水青山就是金山银山"（10字）

**英文meme名称**（按单词数优先，字母数参考）：
- **高质量**（20-25分）：1个单词、3-6字母、简短直观
  - 示例："Duck"（1词4字母）、"Dog"（1词3字母）、"Pepe"（1词4字母）
- **中等质量**（10-19分）：2个单词或7-12字母、有一定意义
  - 示例："Mini Trump"（2词9字母）、"Moon Bag"（2词8字母）、"DogeCoin"（1词8字母）
- **低质量**（0-9分）：3个单词以上或13+字母、过长难记
  - 示例："Fight For Freedom"（3词16字母）、"Silicon Valley Tech"（3词17字母）
...
- **low**：传播潜力≤16 或 总分<50
- **mid**：叙事强度≥25 且 总分≥50 且 传播潜力>16
- **high**：叙事强度≥40 且 总分≥75
