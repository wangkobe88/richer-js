...
function buildFactorsFromTimeSeries(factorValues, tokenState = {}, priceUsd = 0, timestamp = Date.now()) {
  ...
  return {
    ...
    trendDrawdownFromWindowHigh: fv.trendDrawdownFromWindowHigh ?? null,
...
function getAvailableFactorIds() {
  return new Set([
    ...
    'trendRecentDownCount', 'trendRecentDownRatio', 'trendConsecutiveDowns', 'trendDrawdownFromWindowHigh',
    // 持有者趋势因子（固定窗口8个点）
