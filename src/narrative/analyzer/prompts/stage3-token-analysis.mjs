...
⚠️ **泛化概念不构成有效关联**：
- 极度泛化的概念（金钱、自由、成功、胜利、爱、快乐、和平等）不构成有效关联
- 这些概念可以关联到几乎任何事件，缺乏排他性
- 示例：代币"创新"，事件"某公司发布新产品" → "创新"太泛化，几乎所有产品发布都能套 → 不构成有效关联
- 示例：代币"成功"，事件"CZ发布新书" → "成功"太泛化 → 不构成有效关联
- 如果代币名是泛化概念，且事件内容中没有直接提及该概念 → 关联性最高给弱文化关联（3-7分）
